...
import { WhiteCloseIcon } from './icons';

const { width: screenWidth, height: screenHeight } = Dimensions.get('window');

export interface ConferenceMemberData {
  name: string;
  role?: string;
  image?: any;
  country?: string;
...
interface CommitteeFacultyModalProps {
  visible: boolean;
  member: ConferenceMemberData | null;
  onClose: () => void;
}

export const CommitteeFacultyModal: React.FC<CommitteeFacultyModalProps> = ({
  visible,
  member,
  onClose,
}) => {
