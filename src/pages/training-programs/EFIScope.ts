export const EFIScopeContent = {
  heroImage: require('../../assets/images/conference-banner.jpg'),
  title:
  ...
  courseCostTitle: 'Course Cost',
  courseCostGroups: [
    {
      title: 'Indian delegates',
      rows: [
        { label: 'EFI member', amount: '₹ 3,00,000' },
        { label: 'EFI Non-members', amount: '₹ 3,60,000' },
      ],
    },
    {
      title: 'International delegates',
      rows: [
        { label: 'EFI member', amount: '₹ 3,40,000' },
        { label: 'EFI Non-members', amount: '₹ 3,80,000' },
      ],
    },
  ],
  courseCostNote:
  ...
  whyPoints: [
    'Master Robotic Pelvic Surgery – Acquire proficiency in robotic techniques that reduce patient recovery time, improve surgical outcomes, and elevate the quality of care you provide.',
    'Hands-On Experience – Through intensive cadaveric dissection and robotic simulators, gain invaluable practical exposure to the intricate anatomy of the pelvis.',
    'Advanced Endometriosis Management – Deepen your understanding of managing the most challenging cases of endometriosis, and position yourself at the forefront of minimally invasive gynaecologic surgery.',
  ],
  highlightsTitle: 'Course Highlights',
  highlights: [
    'Three day intensive course consisting of two day intensive masterclass with live surgery orientation and robotic simulator, and one day of intensive cadaveric hands-on training.',
    'Learn from national and international experts in robotic surgery and endometriosis management.',
    'Exclusive access – With only 4 seats available (2 for each national and international applicant), this course offers highly personalised training that ensures every participant receives tailored guidance.',
  ],
  programDetails: {
    duration: '3 days',
    format: [
