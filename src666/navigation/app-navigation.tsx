...
import NonResidentialPackages from '../pages/conference/registration/NonResidentialPackages';
import ConferenceRegistrationForm  from '../pages/conference/registration/ConferenceRegistrationForm';
import ResidentialPackages from '../pages/conference/registration/ResidentialPackages';
import ConferencePaymentDetails from '../pages/conference/registration/ConferencePaymentDetails';
import ConferenceQRCode from '../pages/conference/registration/ConferenceQRCode';
...
const {
  ...
  ChooseConferencePackage: React.lazy(
    () => import('../pages/conference/registration/ChooseConferencePackage'),
  ),
};
