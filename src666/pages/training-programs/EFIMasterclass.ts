// export const EFIMasterclassContent = {
//   heroImage: require('../../assets/images/efi-training-img.jpg'),
//   title: 'EFI MASTERCLASS on Robotic / Laparoscopic Surgery in Endometriosis ',
//   description: [
...
//   ],
//   feeTitle: 'Masterclass Fee:',
//   feeSubtitle: 'For two day masterclass',
//   fees: [
//     { label: 'EFI member', amount: '₹ 25,000' },
//     {
//       label: 'Non-member',
//       amount: '₹ 35,000',
//       note: 'Upon registration, non-members will automatically be granted lifetime membership with EFI',
//     },
//   ],
//   highlightsTitle: 'Key Highlights of the EFI Masterclass',
//   highlights: [
