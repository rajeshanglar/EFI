...
const MyPayments: React.FC<MyPaymentsProps> = ({
  ...
  const handlePaymentDetails = (paymentId: string) => {
    ...
    if (transaction) {
      ...
      console.log('Registration Serial Number:', transaction.serial_number);
      ...
      >
        {loading ? (
          <View style={styles.emptyContainer}>
            ...
            <Text style={[styles.emptyText, { marginTop: spacing.md, color: colors.black}]}>
              Loading payments...
            </Text>
          </View>
        ) : error ? (
            ...
            <View key={payment.id} style={styles.paymentCard}>
              ...
              <View style={styles.paymentCardTop}>
                <View style={styles.paymentCardLeft}>                 
                  ...
                  <Text style={styles.paymentTransactionIdLabel}>Serial Number</Text>                  
                 <Text style={styles.paymentTransactionId}>{payment.serial_number}</Text>
